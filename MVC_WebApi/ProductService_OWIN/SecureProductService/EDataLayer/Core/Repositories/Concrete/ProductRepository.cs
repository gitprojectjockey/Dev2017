...
namespace EDataLayer.Core.Repositories.Concrete
{
    public class ProductRepository : Repository<Product>, IProductRepository
    {
        ...
        {
            return _context.Products
                .Count(p => p.ProductName == product.ProductName && p.CompanyId == product.CompanyId && p.ProductCatagoryId == product.ProductCatagoryId ) > 0;
        }
        ...
        public bool ProductRangeExists(IEnumerable<Product> products)
        {
            var matchingCount = products
                 ...
                 .Any(p2 => p2.ProductName == p1.ProductName && p2.CompanyId == p1.CompanyId && p2.ProductCatagoryId == p1.ProductCatagoryId)).Count();
