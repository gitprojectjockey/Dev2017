...
namespace EDataLayer.Core.DataContext.ModelMaps
{
    public class ProductMap : EntityTypeConfiguration<Product>
    {
        public ProductMap()
        {
            ...
            //Create unique compsite key (name,companyId,productCatagoryId) to prevent duplicate entries
            ...
            Property(p => p.ProductCatagoryId)
            ...
            Property<Guid>(p => p.ProductCatagoryId)
              .IsRequired();
            ...
            // One Product Catagory to Many Product Relationship
            HasRequired(p => p.ProductCatagory)
                .WithMany(p => p.Products)
                .HasForeignKey<Guid>(p => p.ProductCatagoryId)
                .WillCascadeOnDelete(false);
